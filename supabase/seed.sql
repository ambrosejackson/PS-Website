...
insert into public.content_heroes (id, page, nav_target, media_url, media_type, theme, is_default, sort_order, is_active) values
  ('10000000-0000-4000-8000-000000000001', '/', null,            '/placeholders/hero-default.webp',       'image', 'dark',  true,  1, true),
  ('10000000-0000-4000-8000-000000000002', '/', 'BRANDS',        '/placeholders/hero-brands.png',        'image', 'dark',  false, 2, true),
  ('10000000-0000-4000-8000-000000000003', '/', 'STORE LOCATOR', '/placeholders/hero-store-locator.png', 'image', 'dark',  false, 3, true),
  ('10000000-0000-4000-8000-000000000004', '/', 'YOUR REWARDS',  '/placeholders/hero-rewards-light.png', 'image', 'light', false, 4, true)
...
insert into public.content_banners (id, media_url, media_type, link_url, badge_text, sort_order, is_active) values
  ('20000000-0000-4000-8000-000000000001', '/placeholders/banner-1.png', 'image', '/products',      'SEASONAL LIMITED DROP', 1, true),
  ('20000000-0000-4000-8000-000000000002', '/placeholders/banner-2.png', 'image', '/apparel',       null,                    2, true),
  ('20000000-0000-4000-8000-000000000003', '/placeholders/banner-3.png', 'image', '/store-locator', null,                    3, true)
on conflict (id) do update set
...
insert into public.product_availability (store_id, brand, product_name, variant, menu_product_url, image_url, checked_at) values
  ('00000000-0000-4000-8000-000000000001', 'Outfitters',           '3.5G Top Shelf Flower',                              '3.5g',  'https://example.com/menus/river-north/top-shelf',  '/placeholders/product.png', now() - interval '1 day'),
  ('00000000-0000-4000-8000-000000000001', 'TerpKings',            '0.5G Live Rosin Astro Vape All-In-One (Fruit/Dessert/Gas)', '0.5g', 'https://example.com/menus/river-north/astro-vape', '/placeholders/product.png', now() - interval '1 day'),
  ('00000000-0000-4000-8000-000000000001', 'Higher Self',          '5-Pack 0.35G Infused Pre-Rolls',                     '5pk',   'https://example.com/menus/river-north/infused-prerolls', '/placeholders/product.png', now() - interval '1 day'),
  ('00000000-0000-4000-8000-000000000002', 'Outfitters',           '3.5G Top Shelf Flower',                              '3.5g',  'https://example.com/menus/wicker-park/top-shelf',  '/placeholders/product.png', now() - interval '2 days'),
  ('00000000-0000-4000-8000-000000000002', 'Savage Squad Strains', '3.5G Exotic Small-Batch Flower',                     '3.5g',  'https://example.com/menus/wicker-park/exotic',     '/placeholders/product.png', now() - interval '2 days'),
  ('00000000-0000-4000-8000-000000000003', 'TerpKings',            '0.5G Live Rosin Astro Vape All-In-One (Fruit/Dessert/Gas)', '0.5g', 'https://example.com/menus/evanston/astro-vape', '/placeholders/product.png', now() - interval '20 days'),
  ('00000000-0000-4000-8000-000000000003', 'Higher Self',          '5-Pack 0.35G Infused Pre-Rolls',                     '5pk',   'https://example.com/menus/evanston/infused-prerolls', '/placeholders/product.png', now() - interval '20 days'),
  ('00000000-0000-4000-8000-000000000004', 'Savage Squad Strains', '3.5G Exotic Small-Batch Flower',                     '3.5g',  'https://example.com/menus/naperville/exotic',      '/placeholders/product.png', now() - interval '35 days');
...
insert into public.catalog_products
  ...
  ('40000000-0000-4000-8000-000000000001', 'Outfitters', '3.5G Top Shelf Flower', 'outfitters-3-5g-top-shelf-flower', 'Flower', 'Whole Flower', '3.5g', '24–28%',
   'Placeholder description — final copy syncs from the iHeartJane sheet.', '/placeholders/product.png',
...
insert into public.merch_products (id, name, slug, description, brand, images, is_active, sort_order) values
  ('50000000-0000-4000-8000-000000000001', 'TS-03', 'ts-03',  'Placeholder merch product.', 'Savage Squad Strains', '["/placeholders/merch-1.png"]', true, 1),
  ('50000000-0000-4000-8000-000000000002', 'TS-07', 'ts-07',  'Placeholder merch product.', 'Savage Squad Strains', '["/placeholders/merch-2.png"]', true, 2),
  ('50000000-0000-4000-8000-000000000003', 'TT-06', 'tt-06',  'Placeholder merch product.', null,                   '["/placeholders/merch-3.png"]', true, 3),
  ('50000000-0000-4000-8000-000000000004', 'LS-03', 'ls-03',  'Placeholder merch product.', null,                   '["/placeholders/merch-4.png"]', true, 4),
  ('50000000-0000-4000-8000-000000000005', 'HD-10', 'hd-10',  'Placeholder merch product.', 'Outfitters',           '["/placeholders/merch-1.png"]', true, 5),
  ('50000000-0000-4000-8000-000000000006', 'JC-08', 'jc-08',  'Placeholder merch product.', 'Outfitters',           '["/placeholders/merch-2.png"]', true, 6),
  ('50000000-0000-4000-8000-000000000007', 'PK-01', 'pk-01',  'Placeholder merch product.', 'Outfitters',           '["/placeholders/merch-3.png"]', true, 7),
  ('50000000-0000-4000-8000-000000000008', 'HT-05', 'ht-05',  'Placeholder merch product.', 'Outfitters',           '["/placeholders/merch-4.png"]', true, 8),
  ('50000000-0000-4000-8000-000000000009', 'BG-02', 'bg-02',  'Placeholder merch product.', 'Outfitters',           '["/placeholders/merch-1.png"]', true, 9),
  ('50000000-0000-4000-8000-000000000010', 'GL-01', 'gl-01',  'Placeholder merch product.', 'Outfitters',           '["/placeholders/merch-2.png"]', true, 10),
  ('50000000-0000-4000-8000-000000000011', 'ZH-02', 'zh-02',  'Placeholder merch product.', 'Higher Self',          '["/placeholders/merch-3.png"]', true, 11),
  ('50000000-0000-4000-8000-000000000012', 'CP-04', 'cp-04',  'Placeholder merch product.', 'Higher Self',          '["/placeholders/merch-4.png"]', true, 12);
